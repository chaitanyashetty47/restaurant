  ...
  return (
    <section className="relative h-screen">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
          <h1 className="text-4xl md:text-6xl font-serif text-center mb-8 mt-16">
            Stays That Feel Like Home
          </h1>
          <h1 className="text-lg md:text-lg font-serif text-center mb-8 m">Spacious Studio Rooms, Exceptional Service, and a Tranquil Stay in the Heart of Vadodara</h1>
          <form onSubmit={(e: React.FormEvent<HTMLFormElement>) => {
            e.preventDefault();
            // Handle form submission here
          }} className="bg-black/40 p-6 rounded-lg max-w-4xl w-full mx-4">
